...
data class HomeUiState(
    ...
    val missingPermissions: List<com.ciobert.wol.util.PermissionsHelper.PermissionItem> = emptyList()
)
...
class HomeViewModel @Inject constructor(
    ...
    val uiState: StateFlow<HomeUiState> = combine(
        ...
        HomeUiState(
            ...
            missingPermissions = com.ciobert.wol.util.PermissionsHelper.getMissingPermissions(context)
        )
    }.stateIn(
