package com.gemini.wol.ui.navigation
...
import com.gemini.wol.ui.screen.AddEditPcScreen
import com.gemini.wol.ui.screen.DashboardScreen
import com.gemini.wol.ui.screen.ScheduleScreen
...
fun WolNavigation() {
    ...
    NavHost(
        ...
        composable("main") {
            com.gemini.wol.ui.screen.MainScreen(
        ...
        composable("all_schedules") {
            com.gemini.wol.ui.screen.AllSchedulesScreen(
                onNavigateUp = { navController.navigateUp() }
            )
        }
    }
